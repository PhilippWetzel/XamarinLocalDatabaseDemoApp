...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "XamarinLocalDatabaseDemoApp.Android.dll" comes first in this list. */
		"XamarinLocalDatabaseDemoApp.Android.dll",
		"FormsViewGroup.dll",
		"SQLite-net.dll",
		...
		"XamarinLocalDatabaseDemoApp.dll",
	};
